...
final purchaseDetailsProvider =
    FutureProvider.family<Map<String, dynamic>?, int>((ref, purchaseId) async {
      ...
      return {
        'purchase': {
          ...
          'purchase_date': purchase['created_at']?.toString().split(' ')[0],
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        rows: items.map((item) {
          ...
          final gstRate = item['gst_rate'] as num? ?? 0;
