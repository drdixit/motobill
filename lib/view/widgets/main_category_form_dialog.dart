...
class MainCategoryFormDialog extends StatefulWidget {
  final MainCategory? category;
  final Function(MainCategory) onSave;

  const MainCategoryFormDialog({
    super.key,
    this.category,
  ...
  @override
  State<MainCategoryFormDialog> createState() => _MainCategoryFormDialogState();
}

class _MainCategoryFormDialogState extends State<MainCategoryFormDialog> {
  ...
  void initState() {
    ...
    _selectedImageFileName = widget.category?.image;
  }
